...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-36FFO3FA.js";
import "./chunk-UP3HH4JE.js";
import {
  DismissableLayer,
  Portal,
  Root,
  ...
  __generator,
  __spread
} from "./chunk-JULJOQFD.js";
import {
  useId
} from "./chunk-Q3GNHVPK.js";
import {
  Presence
} from "./chunk-YODHLPDO.js";
import {
  useControllableState
} from "./chunk-DICK6R3D.js";
import {
  composeEventHandlers,
  createContextScope
} from "./chunk-DYUDPLB6.js";
import {
  Primitive
...
var TooltipContent = React.forwardRef(
  (props3, forwardedRef) => {
    const portalContext = usePortalContext(CONTENT_NAME, props3.__scopeTooltip);
    const { forceMount = portalContext.forceMount, side = "top", ...contentProps } = props3;
    const context = useTooltipContext(CONTENT_NAME, props3.__scopeTooltip);
...
var TooltipContentHoverable = React.forwardRef((props3, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME, props3.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME, props3.__scopeTooltip);
  const ref = React.useRef(null);
  ...
  return (0, import_jsx_runtime.jsx)(TooltipContentImpl, { ...props3, ref: composedRefs });
});
        ...
        children: (0, import_jsx_runtime.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
function evaluate(expr) {
  ...
  if (parens.test(expr)) {
    return evaluate(expr.replace(parens, (_2, subExpr) => evaluate(subExpr).toString()));
  }
  if (exp.test(expr)) {
    return evaluate(expr.replace(exp, (_2, a4, b4) => Math.pow(Number(a4), Number(b4)).toString()));
  }
  if (muldiv.test(expr)) {
    return evaluate(expr.replace(muldiv, (_2, a4, op, b4) => op === "*" ? (Number(a4) * Number(b4)).toString() : Number(b4) === 0 ? (() => {
      throw new Error("Division by zero");
    })() : (Number(a4) / Number(b4)).toString()));
  }
  if (addsub.test(expr)) {
    return evaluate(expr.replace(addsub, (_2, a4, op, b4) => op === "+" ? (Number(a4) + Number(b4)).toString() : (Number(a4) - Number(b4)).toString()));
  }
  return Number(expr);
}
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react2.useCallback)((v4) => onUpdate(parseNumber(v4)), [onUpdate]);
...
var ToolTipArrow = styled(Arrow2, {
...
function useInputSetters({
  ...
  const setFormat = (0, import_react2.useCallback)((v4) => setDisplayValue(format$2(type, v4, settingsRef.current)), [type]);
...
function Vector({
  ...
  }), Object.keys(value).map((key, i4) => import_react2.default.createElement(Coordinate, {
    id: i4 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
function i3(e4) {
  var t4 = (0, import_react5.useRef)(e4), n4 = (0, import_react5.useRef)(function(e5) {
...
var m3 = import_react5.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s4 = c3(o4, ["onMove", "onKey"]), m4 = (0, import_react5.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react5.useRef)(null), _2 = (0, import_react5.useRef)(false), x3 = (0, import_react5.useMemo)(function() {
    var e4 = function(e5) {
  ...
  return (0, import_react5.useEffect)(function() {
    return H3;
  }, [H3]), import_react5.default.createElement("div", u3({}, s4, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m4, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g3 = function(e4) {
...
var p3 = function(r4) {
  ...
  return import_react5.default.createElement("div", { className: l4, style: { top: 100 * a4 + "%", left: 100 * n4 + "%" } }, import_react5.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t4 } }));
};
...
var S3 = import_react5.default.memo(function(r4) {
  var t4 = r4.hue, n4 = r4.onChange, o4 = g3(["react-colorful__hue", r4.className]);
  return import_react5.default.createElement("div", { className: o4 }, import_react5.default.createElement(m3, { onMove: function(e4) {
    n4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    n4({ h: s3(t4 + 360 * e4.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b3(t4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react5.default.createElement(p3, { className: "react-colorful__hue-pointer", left: t4 / 360, color: q2({ h: t4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react5.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o4 = { backgroundColor: q2({ h: t4.h, s: 100, v: 100, a: 1 }) };
  return import_react5.default.createElement("div", { className: "react-colorful__saturation", style: o4 }, import_react5.default.createElement(m3, { onMove: function(e4) {
    n4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    n4({ s: s3(t4.s + 100 * e4.left, 0, 100), v: s3(t4.v - 100 * e4.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(t4.s) + "%, Brightness " + b3(t4.v) + "%" }, import_react5.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - t4.v / 100, left: t4.s / 100, color: q2(t4) })));
});
...
function Y2(e4, t4, l4) {
  var u4 = i3(l4), c4 = (0, import_react5.useState)(function() {
    return e4.toHsva(t4);
  }), s4 = c4[0], f4 = c4[1], v4 = (0, import_react5.useRef)({ color: t4, hsva: s4 });
  (0, import_react5.useEffect)(function() {
    if (!e4.equal(t4, v4.current.color)) {
      var r4 = e4.toHsva(t4);
      v4.current = { hsva: r4, color: t4 }, f4(r4);
    }
  }, [t4, e4]), (0, import_react5.useEffect)(function() {
    var r4;
    F2(s4, v4.current.hsva) || e4.equal(r4 = e4.fromHsva(s4), v4.current.color) || (v4.current = { hsva: s4, color: r4 }, u4(r4));
  }, [s4, e4, u4]);
  var d4 = (0, import_react5.useCallback)(function(e5) {
    f4(function(r4) {
...
var U2 = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react5.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react5.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react5.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react5.default.createElement(S3, { hue: d4.h, onChange: h4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  ...
  return import_react5.default.createElement("div", { className: l4 }, import_react5.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a4 }), import_react5.default.createElement(m3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(n4.a + e4.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u4 + "%", "aria-valuenow": u4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react5.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: n4.a, color: k3(n4) })));
};
var re = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react5.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react5.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react5.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react5.default.createElement(S3, { hue: d4.h, onChange: h4 }), import_react5.default.createElement(ee, { hsva: d4, onChange: h4, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r4) {
  return import_react5.default.createElement(re, u3({}, r4, { colorModel: xe }));
};
...
var Ne = function(r4) {
  return import_react5.default.createElement(U2, u3({}, r4, { colorModel: Me }));
};
...
function create(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react7.useReducer)((c4) => c4 + 1, 0);
